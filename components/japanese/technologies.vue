<template>
  ...
  >
    ...
    <article
      class="grid w-full grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4"
    >
      <TechnologiesCard>
        ...
        <template v-slot:area>Backend</template>
      </TechnologiesCard>
      <TechnologiesCard>
        <template v-slot:logo>
          <svg
        ...
        <template v-slot:area>Backend, Command Line</template>
      </TechnologiesCard>
      <TechnologiesCard>
        <template v-slot:logo>
          <svg
        ...
        <template v-slot:area>Frontend</template>
      </TechnologiesCard>
      <TechnologiesCard>
        <template v-slot:logo>
          <svg
...
onMounted(() => {
  ...
  observer.observe(technologies.value);
});
</script>

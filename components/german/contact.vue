<template>
  <section
    id="contact"
    ref="contact"
    class="relative w-full mx-auto flex min-h-screen max-w-2xl -translate-x-1/2 flex-col items-center justify-center gap-4 opacity-0 transition-all duration-500"
  >
    ...
    <form @submit.prevent="submitForm" class="flex w-full flex-col gap-4">
      ...
      <button
        class="my-4 w-full rounded bg-green-700 py-4 text-green-100 transition-all hover:scale-105 hover:shadow-lg hover:shadow-green-700/20 flex gap-2 justify-center"
        type="submit"
      >
